...
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/2;         // 750KB  block soft limit
...
static const int64 MAX_MONEY = 15000000000 * COIN; // PokéCoin: maximum of 150B coins (given some randomness), max transaction 15,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // PokéCoin: 1440 blocks found a day. Priority cutoff is 100 pokécoin day / 250 bytes.
    }
