...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pokécoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pokécoin.com", "seed.pokécoin.com"},
    {"mophides.com", "seed.mophides.com"},
    {"dglibrary.org", "seed.dglibrary.org"},
//    {"pokécoinpool.org", "dnsseed.pokécoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pokécoin is probably already running."), addrBind.ToString().c_str());
        else
